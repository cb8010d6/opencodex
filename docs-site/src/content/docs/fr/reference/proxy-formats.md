...
| 400 | `unreadable_encrypted_agent_task` | Une tâche de travail v2 chiffrée n'a pas de cible ChatGPT canonique ni de cible Responses explicitement approuvée pouvant la traiter |
