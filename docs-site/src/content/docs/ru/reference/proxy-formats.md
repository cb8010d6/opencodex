...
| 400 | `unreadable_encrypted_agent_task` | У шифрованной задачи воркера v2 нет канонической цели ChatGPT или явно доверенной Responses-цели, способной её обработать |
