...
`encrypted_content`. Эту нагрузку может прочитать нативный backend ChatGPT или явно разрешённый
Responses-провайдер, способный прозрачно передать ciphertext. Это известное ограничение
