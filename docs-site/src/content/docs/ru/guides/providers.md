...
Для зашифрованных дочерних задач V2 каноническая пересылка ChatGPT доверена неявно. Привязанный к
назначению opt-in, требования к итоговому wire и безопасное завершение неканонических Responses-
маршрутов описаны в [справочнике конфигурации провайдеров](/ru/reference/configuration/providers/).
