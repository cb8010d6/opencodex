...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "pws.encryptedV2PassthroughDesc": "이 Responses 엔드포인트가 Codex의 불투명한 암호화 작업을 처리할 수 있다고 신뢰합니다. OpenCodex는 이를 복호화하거나 복구하지 않습니다. 프로바이더 호환성을 확인한 후에만 활성화하세요.",
  "pws.encryptedV2Confirm": "이 프로바이더에게 불투명한 암호화 V2 에이전트 작업을 맡기시겠습니까? 호환되지 않는 엔드포인트는 읽을 수 있는 작업 없이 실패할 수 있습니다.",
