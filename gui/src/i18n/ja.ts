...
"common.discard": "破棄",
 ...
 "quota.fiveHourLimit": "5 時間上限",
  ...
  "pws.encryptedV2PassthroughDesc": "この Responses エンドポイントが Codex の不透明な暗号化タスクを処理できるものとして信頼します。OpenCodex は復号や復元を行いません。プロバイダーの互換性を確認してから有効にしてください。",
  "pws.encryptedV2Confirm": "このプロバイダーに不透明な暗号化 V2 エージェントタスクを委ねますか？互換性のないエンドポイントでは読み取り可能なタスクがなく失敗する場合があります。",
