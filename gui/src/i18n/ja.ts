...
"common.discard": "破棄",
 ...
 "quota.fiveHourLimit": "5 時間上限",
  ...
  "pws.encryptedV2Passthrough": "暗号化された V2 エージェントタスクを転送",
  "pws.encryptedV2PassthroughDesc": "この Responses エンドポイントが Codex の不透明な暗号化 V2 サブタスクの暗号文を消費またはリレーできるものとして信頼します。OpenCodex はその復号、翻訳、復元を行いません。プロバイダーの互換性を確認してから有効にしてください。",
  "pws.encryptedV2Confirm": "このプロバイダーに不透明な暗号化 V2 エージェントタスクの暗号文の消費、またはバイトそのままのリレーを委ねますか？互換性がない場合は、平文を要求するか暗号文を変更するためにエンドポイントが失敗する可能性があります。",
