...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "pws.encryptedV2Passthrough": "Verschlüsselte V2-Agent-Aufgaben durchleiten",
  "pws.encryptedV2PassthroughDesc": "Diesem Responses-Endpunkt vertrauen, Codex’ undurchsichtige verschlüsselte V2-Kindaufgaben zu verarbeiten oder unverändert weiterzuleiten. OpenCodex entschlüsselt, übersetzt oder rekonstruiert sie nicht. Nur nach bestätigter Anbieterkompatibilität aktivieren.",
  "pws.encryptedV2Confirm": "Diesem Anbieter undurchsichtige verschlüsselte V2-Kindaufgaben zum Verarbeiten oder unveränderten Weiterleiten anvertrauen? Inkompatible Endpunkte können fehlschlagen, wenn sie Klartext erfordern oder den verschlüsselten Text ändern.",
