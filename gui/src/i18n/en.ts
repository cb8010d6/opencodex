...
"common.discard": "Discard",
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "pws.encryptedV2PassthroughDesc": "Trust this Responses endpoint to consume Codex's opaque encrypted task. OpenCodex will not decrypt or recover it. Enable only after verifying provider compatibility.",
  "pws.encryptedV2Confirm": "Trust this provider with opaque encrypted V2 agent tasks? Incompatible endpoints may fail without a readable assignment.",
