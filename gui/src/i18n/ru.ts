...
"common.discard": "Отбросить",
 ...
 "quota.fiveHourLimit": "5-часовой лимит",
  ...
  "pws.encryptedV2Passthrough": "Передавать зашифрованные задачи агентов V2",
  "pws.encryptedV2PassthroughDesc": "Доверять этому Responses-эндпоинту обработку или ретрансляцию без изменений непрозрачного зашифрованного текста дочерних задач V2 Codex. OpenCodex не расшифровывает, не переводит и не восстанавливает его. Включайте только после проверки совместимости провайдера.",
  "pws.encryptedV2Confirm": "Доверить этому провайдеру обработку непрозрачного зашифрованного текста дочерних задач V2 или его ретрансляцию побайтово без изменений? Несовместимый эндпоинт может завершиться ошибкой, если он требует открытый текст или изменяет зашифрованный текст.",
