...
"common.discard": "Отбросить",
 ...
 "quota.fiveHourLimit": "5-часовой лимит",
  ...
  "pws.encryptedV2PassthroughDesc": "Доверять этому Responses-эндпоинту обработку непрозрачной зашифрованной задачи Codex. OpenCodex не расшифровывает и не восстанавливает её. Включайте только после проверки совместимости провайдера.",
  "pws.encryptedV2Confirm": "Доверить этому провайдеру непрозрачные зашифрованные задачи агентов V2? Несовместимый эндпоинт может завершиться ошибкой без читаемого задания.",
