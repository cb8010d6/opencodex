...
"common.discard": "Отбросить",
 ...
 "logs.filter.conversation.clear": "Сбросить",
  ...
  "logs.col.decodeTokPerSec": "декодирование tok/s",
  "logs.col.estimatedCost": "~$",
  "logs.metric.tokPerSecTitle": "Выходные токены в секунду за полную длительность запроса",
  "logs.metric.decodeTokPerSecTitle": "Оценка выходных токенов в секунду после TTFT; измеренный интервал всё ещё включает завершение потока и сетевые паузы",
  ...
  "logs.detail.reason.ttft_missing": "Для этого запроса TTFT не был записан.",
